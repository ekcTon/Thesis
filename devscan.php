     ...
     <script>
        ...
        function ratio(){
            ...
            if($format == $('#135M')[0].value){
                ...
                htmlQuery +='<select onchange="compare()" style="width:25%;margin-bottom:10px" id="ratio">'
        ...
        function compare(){
            ...
            $.ajax({
                url:'comparedevscan.php',
                type:'post',
                data:{  
                    format:checkformatcompare,
                    ratio:checkratiocompare,
                    type:checktypecompare
                    },
    ...
    <?php include('./navbar.php') ?>
        <div class="container">
            <div class="wrapper" style="display:flex;flex-direction:row;width:100%;height:auto;margin-top:30px">
                ...
                <img src="./img/devscan.jpg" style="width:300px;height:300px;object-fit:contain;" alt="">
                </div>
                <div style="display:flex;flex-direction:column;width:50%;height:auto">
                <div style="color:white;background-color:#0c0d10;font-family:Oxanium;font-size:30px;margin-bottom:5px">Dev&Scan</div>
                    ...
                    <div id="2">
                    <!-- <p style="color:white;background-color:#0c0d10;font-family:Oxanium;font-size:16px">Ratio</p>
                        <select style="width:25%;margin-bottom:10px" name="type">
                            <option value="ฟิล์มสี 135">Standard 3000x2000 PX</option>
                            <option value="ฟิล์มขาวดำ 135">Half Frame2000x1400 PX</option>
                            <option value="ฟิล์มสี 120">Panorama 5400x2000 PX</option>
                            <option value="ฟิล์ขาวดำ 120">Sprocket Hole 3600x3600 PX</option>
                        </select> -->
                    </div>

                    <div id="3">
                        <!-- <select style="width:25%;margin-bottom:10px" name="type">
                            <option value="ฟิล์มสี 135">555555555</option>
                            <option value="ฟิล์มขาวดำ 135">Half Frame2000x1400 PX</option>
                            <option value="ฟิล์มสี 120">Panorama 5400x2000 PX</option>
                            <option value="ฟิล์ขาวดำ 120">Sprocket Hole 3600x3600 PX</option>
                        </select> -->
                    ...
                    <div id="4">
                        <!-- <select style="width:25%;margin-bottom:10px" name="type">
                            <option value="ฟิล์มสี 135">666666666</option>
                            <option value="ฟิล์มขาวดำ 135">Half Frame2000x1400 PX</option>
                            <option value="ฟิล์มสี 120">Panorama 5400x2000 PX</option>
                            <option value="ฟิล์ขาวดำ 120">Sprocket Hole 3600x3600 PX</option>
                        </select> -->
                    ...
                    <select onchange="compare()" style="width:25%;margin-bottom:10px" id="type">
                        <option value="Dev&ScanC">Color</option>
                        <option value="Dev&ScanBW">Black&White</option>
                    </select>
                    <p style="color:white;background-color:#0c0d10;font-family:Oxanium;font-size:16px">Amount</p>
                    <input style="color:black;background:white;width:25%" type="number" id="buyamount" min="1" max="5" value="1" require>
